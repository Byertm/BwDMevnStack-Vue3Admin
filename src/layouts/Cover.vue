<template>
	<div class="uk-light wrap uk-background-norepeat uk-background-cover uk-background-center-center uk-cover-container uk-background-secondary">
		<img
			data-srcset="//picsum.photos/640/700/?image=482 640w,
							//picsum.photos/960/700/?image=482 960w,
							//picsum.photos/1200/900/?image=482 1200w,
							//picsum.photos/2000/1000/?image=482 2000w"
			sizes="100vw"
			data-src="//picsum.photos/1200/900/?image=482"
			alt=""
			data-uk-cover
			data-uk-img />
		...
		<div class="uk-flex uk-flex-center uk-flex-middle uk-height-viewport uk-position-z-index uk-position-relative" data-uk-height-viewport="min-height: 400" style="background-color: rgba(0, 0, 0, 0.5)">
					...
					<nav class="uk-navbar-container uk-navbar-transparent" data-uk-navbar>
						<div class="uk-navbar-left">
							<div class="uk-navbar-item">
								<a class="uk-logo" href=""><img src="//zzseba78.github.io/Kick-Off/img/cover-logo.svg" alt="Logo" /></a>
							</div>
						</div>
			...
			<div class="uk-position-bottom-center uk-position-small uk-visible@m uk-position-z-index">
				<p class="uk-text-small uk-text-center">
					© 2023 Byertm Web - <a href="https://github.com/ersinbiltekin/BwDAdmin">Created by Byertm</a> | Built with
					<a href="http://getuikit.com" title="Visit UIkit 3 site" target="_blank" data-uk-tooltip><span data-uk-icon="uikit"></span></a>
				</p>
			</div>
			<!-- /FOOT -->
		</div>
	...
	<div id="offcanvas-nav" data-uk-offcanvas="flip: true; overlay: false">
		<div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
			...
			<ul class="uk-nav uk-nav-default">
				...
				<li>
					<a href="#js-options"><span class="uk-margin-small-right uk-icon" data-uk-icon="icon: table"></span> Item</a>
				</li>
				<li>
					<a href="#"><span class="uk-margin-small-right uk-icon" data-uk-icon="icon: thumbnails"></span> Item</a>
				</li>
				<li class="uk-nav-divider"></li>
				<li>
					<a href="#"><span class="uk-margin-small-right uk-icon" data-uk-icon="icon: trash"></span> Item</a>
				</li>
			</ul>
			<h3>Title</h3>
			<p>
